...
const FooterSection: React.FC = () => {
    ...
    return (
        <div className="bg-[#232528] text-white flex flex-col pt-[40px]">
            <h2 className="relative before:absolute before:bg-[#f15221] before:bottom-0 before:left-0 before:h-full w-fit flex xl:hidden
            ...
            <div className="grid grid-cols-2 lg:grid-cols-6 xl:grid-cols-7 pb-[80px] mx-[40px] lg:mx-[60px] xl:mx-[120px] lg:mt-[40px] xl:mt-0">
                <h2 className="relative before:absolute before:bg-[#f15221] before:bottom-0 before:left-0 before:h-full w-fit hidden xl:flex
