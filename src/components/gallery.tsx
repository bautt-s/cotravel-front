...
const GallerySection: React.FC = () => {
    return (
        <div className="flex flex-col px-[40px] lg:px-[80px] xl:px-[120px] py-[60px] lg:py-[120px] items-center">
            <span className="text-[#f15221] font-bold text-lg">GALLERY OF OUR TRIPS</span>
            <h1 className="merriweather text-4xl lg:text-5xl font-semibold mt-[10px] text-[#1a1a1a]">Completed journeys</h1>
