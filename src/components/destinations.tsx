...
const DestinationsSection: React.FC = () => {
    ...
    return (
        <div className="px-[40px] lg:px-[80px] xl:px-[120px] pb-[80px] pt-[140px] dark:bg-[#131313] transition-colors duration-300">
            <span className="text-[#f15221] dark:text-[#ff764d] font-bold text-lg">WHERE TO GO</span>
            <h1 className="text-5xl font-semibold mt-[10px] merriweather text-[#1a1a1a] dark:text-white">Popular Destinations</h1>
                    ...
                    <SwiperSlide key={index} className={`group  ${d.img !== 'indonesia' ? 'ml-[-125px] sm:ml-[0] xl:ml-[-15px]' : 'ml-0'} `}>
                        ...
                        transition-all duration-300 shadow-[0px_15px_20px_0px_rgba(0,0,0,0.15)] dark:shadow-[0px_15px_20px_0px_rgba(255,255,255,0.05)]`}>
                            <div className="text-center mb-[30px] text-white">
                                ...
                                <div className="[transform:translateZ(0)] px-6 py-3 rounded-full overflow-hidden mt-[10px] before:w-12 w-fit mx-auto
                                 relative before:absolute before:bg-[#f15221] dark:before:bg-[#ff764d] before:top-1/2 before:left-1/2 before:h-8 
            ...
            <div className="flex flex-row items-center">
                <div className="group w-[200px] [transform:translateZ(0)] px-[15px] py-3 rounded-full overflow-hidden mt-[40px] text-center border border-[#f15221] dark:border-none 
                relative before:absolute before:bg-[#f15221] before:bottom-0 before:left-0 before:h-full before:w-full before:duration-500 cursor-pointer dark:bg-[#ff764d] dark:text-white
                before:origin-[100%_100%] before:scale-x-0 hover:before:origin-[0_0] hover:before:scale-x-100 before:transition before:ease-in-out text-[#f15221] dark:before:bg-[#e26842]">
                ...
                <span className="text-[#919191] dark:text-[#ececec] ml-auto font-bold text-md underline decoration-[2px] decoration-[#f15221] cursor-pointer mt-[40px]">
                    +50 UNIQUE LOCATIONS
                </span>
            </div>
        </div>
